...
function createRecallTrial(instruction, background, textClass) {
  ...
  timeline.push({
    ...
    <h3> <span style="font-weight:normal">Kutsume sind osalema uuringus </span><br>"Taustavärvi ja sõnade fondi suuruse mõju mälule"</h3>
